...
object ThemeSerializer {
    ...
    fun toKotlinSnippet(theme: CalendarTheme, variableName: String = "myTheme"): String = buildString {
        ...
        append("    primaryColor = 0x${theme.primaryColor.toUInt().toString(16).toUpperCase(java.util.Locale.ROOT)}.toInt(),\n")
        append("    todayIndicatorColor = 0x${theme.todayIndicatorColor.toUInt().toString(16).toUpperCase(java.util.Locale.ROOT)}.toInt(),\n")
        append("    selectedDayColor = 0x${theme.selectedDayColor.toUInt().toString(16).toUpperCase(java.util.Locale.ROOT)}.toInt(),\n")
        append("    fridayTextColor = 0x${theme.fridayTextColor.toUInt().toString(16).toUpperCase(java.util.Locale.ROOT)}.toInt(),\n")
        append("    saturdayTextColor = 0x${theme.saturdayTextColor.toUInt().toString(16).toUpperCase(java.util.Locale.ROOT)}.toInt(),\n")
        append("    holidayDotColor = 0x${theme.holidayDotColor.toUInt().toString(16).toUpperCase(java.util.Locale.ROOT)}.toInt(),\n")
        append("    backgroundColor = 0x${theme.backgroundColor.toUInt().toString(16).toUpperCase(java.util.Locale.ROOT)}.toInt(),\n")
